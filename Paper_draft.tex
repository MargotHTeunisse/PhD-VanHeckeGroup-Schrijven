...
When we define the state $S = \{s_1, s_2, ..., s_N\}$, the labelling of hysterons 1 through N is arbitrary. As a result, when two graphs only differ from one another by the ordering of the hysterons 1, 2, ..., N, we consider the graphs to be the same (Fig. \ref{fig:exchangeplusgoe}a).\\
