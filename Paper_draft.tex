...
In a scrambled graph, one or more of the transitions in the graph deviates from the main loop, so that each main loop corresponds to a number of base graphs (Fig.\ref{fig:basegraphs_n3}).\\
